...
class TestCLI(unittest.TestCase):
    ...
    def setUp(self):
        ...
        #Input of CLI
        self.args = [['-l','XMLFiles/TM1.xml','-i','6,8'],['-l','XMLFiles/TM1.xml','-e','CSVFiles/iTM1.csv'],['-l','XMLFiles/TM1.xml','-i','6,8','-o','CSVFiles/output.csv'],['-l','XMLFiles/TM1.xml','-e','CSVFiles/iTM1.csv','-o','CSVFiles/output.csv'],['-o','CSVFiles/output.csv','-e','CSVFiles/iTM1.csv','-l','XMLFiles/TM1.xml'],['-l','XMLFiles/TM1.xml','-e','CSVFiles/iTM1s.csv'],['-l','XMLFiles/TM1.xml','-i','6'],['-l','XMLFiles/TM1.xml','-i','6,8,9'],['-l','XMLFiles/TM.xml','-e','CSVFiles/iTM1.csv'],['-l','XMLFiles/TM1.xml','-e','CSVFiles/inpu.csv'],['-l','XMLFiles/empty.xml','-e','CSVFiles/TM1.csv'],['-l','XMLFiles/TM1.xml','-e','CSVFiles/empty.csv'],['-l','XMLFiles/TM1.xml','-e','CSVFiles/iTM1i.csv'],['-l','XMLFiles/TM1.xml','-e','CSVFiles/iTM1f.csv'],['-l','XMLFiles/TM1','-e','CSVFiles/iTM1.csv'],['-l','XMLFiles/TM1.xml','-e','CSVFiles/input'],['-l','XMLFiles/TM1.xml','-e','CSVFiles/iTM1.csv','-o','CSVFiles/output'],['-l','XMLFiles/TM1.xml','-i','a'],['-l','XMLFiles/TM1.xml','-i','a,b'],['-l','XMLFiles/TM1.xml','-e','CSVFiles/1str.csv'],['-l','XMLFiles/TM1.xml','-e','CSVFiles/2str.csv'],['-l','XMLFiles/TM1.xml','-e','CSVFiles/1int1str.csv'],['-l','XMLFiles/TM1.xml'],[]]
        #Expected Output
        self.expect = ['12.345622\n','12.345622\n11.537991\n10.862398\n10.151207\n','12.345622\n','12.345622,11.537991,10.862398,10.151207\n','12.345622,11.537991,10.862398,10.151207\n','12.345622\n','Wrong number of arguments in Evaluate\n','Wrong number of arguments in Evaluate\n','A file isn\'t found\n','A file isn\'t found\n','A file is empty\n','A file is empty\n','Wrong number of arguments in Evaluate\n','Wrong number of arguments in Evaluate\n','A file haven\'t the correct extension\n','A file haven\'t the correct extension\n','A file haven\'t the correct extension\n','Values must be Integer or Float in Evaluate\n','Values must be Integer or Float in Evaluate\n','Values must be Integer or Float in Evaluate\n','Values must be Integer or Float in Evaluate\n','Values must be Integer or Float in Evaluate\n','Can\'t be executed only Load\n','Wrong or missing option\n']
    ...
    #Load + Evaluate with file csv with more than 2 values on first row
    def test_12(self):
        index = 12
        result = self.runner[index].invoke(cli.startCLI,self.args[index])
        self.assertEqual(result.output,self.expect[index])
