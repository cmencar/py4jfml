...
class LeftGaussianMembershipFunction:
    '''
        Python class for representing LeftGaussian membership functions
    '''
    def __init__(self,p=None,domainLeft=None,domainRight=None):
        '''
        Constructor of class LeftGaussianMembershipFunction
        ...
        if p==None and domainLeft==None and domainRight==None:
            self.java_mf = gateway.entry_point.getJFMLMembershipfunction_Factory().createLeftGaussianMembershipFunction()
        ...
        #Call of the java constructor with Parameter instance with parameters of the function
            ...
            self.java_mf = gateway.entry_point.getJFMLMembershipfunction_Factory().createLeftGaussianMembershipFunction(p.java_p)
        ...
        #Call of the java constructor with Parameter instance with parameters of the function and the left and right domain
            ...
            self.java_mf = gateway.entry_point.getJFMLMembershipfunction_Factory().createLeftGaussianMembershipFunction(p.java_p,domainLeft,domainRight)
