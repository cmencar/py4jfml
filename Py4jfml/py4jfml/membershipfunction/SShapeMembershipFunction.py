...
class SShapeMembershipFunction:
    '''
    Python class for representing S-Shape functions
    '''
    def __init__(self,p=None,domainLeft=None,domainRight=None):
        '''
        Constructor of class SShapeMembershipFunction
        ...
        if p==None and domainLeft==None and domainRight==None:
            self.java_mf = gateway.entry_point.getJFMLMembershipfunction_Factory().createSShapeMembershipFunction()
        ...
        #Call of the java constructor with a Parameter
            ...
            self.java_mf = gateway.entry_point.getJFMLMembershipfunction_Factory().createSShapeMembershipFunction(p.java_p)
        ...
        #Call of the java constructor with a parameter and left and right domain
            ...
            self.java_mf = gateway.entry_point.getJFMLMembershipfunction_Factory().createSShapeMembershipFunction(p.java_p,domainLeft,domainRight)
