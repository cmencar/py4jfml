...
class RuleBaseType(FuzzySystemRuleBase):
    ...
    def __init__(self, name=None, ruleBaseType=None, activation=None, andAlgorithm=None, orAlgorithm=None):
        ...
        if name==None and ruleBaseType==None and activation==None and andAlgorithm==None and orAlgorithm==None:
            ...
            assert type(name)==str and type(ruleBaseType)==int
            self.java_fsrb = gateway.entry_point.getJFMLRulebase_Factory().createRuleBaseType(name, ruleBaseType)
        elif name!=None and ruleBaseType!=None and activation!=None and andAlgorithm!=None and orAlgorithm!=None:
            ...
            self.java_fsrb = gateway.entry_point.getJFMLRulebase_Factory().createRuleBaseType(name, activation, andAlgorithm, orAlgorithm, ruleBaseType)
