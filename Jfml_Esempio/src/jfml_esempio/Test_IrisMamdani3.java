...
public class Test_IrisMamdani3 {
	...
	public static void main(String[] args) {
		...
		FuzzyTermType pw_lowPi = new FuzzyTermType("lowPi", FuzzyTermType.TYPE_piShape, (new float[] { 1.f, 1.2f }));
		pw.addFuzzyTerm(pw_lowPi);
		FuzzyTermType pw_lowZ = new FuzzyTermType("lowZ", FuzzyTermType.TYPE_zShape, (new float[] { 1.f, 0.2f }));
		...
		FuzzyTermType pw_highS = new FuzzyTermType("highS", FuzzyTermType.TYPE_sShape, (new float[] { 2.f, 0.2f }));
		...
		// FUZZY TERM setosa
		FuzzyTermType irisClass_setosa = new FuzzyTermType("setosa", FuzzyTermType.TYPE_singletonShape,
				(new float[] { 1f }));
		irisClass.addFuzzyTerm(irisClass_setosa);
		// FUZZY TERM virginica
		FuzzyTermType irisClass_virginica = new FuzzyTermType("virginica", FuzzyTermType.TYPE_singletonShape,
				(new float[] { 2f }));
		irisClass.addFuzzyTerm(irisClass_virginica);
		// FUZZY TERM versicolor
		FuzzyTermType irisClass_versicolor = new FuzzyTermType("versicolor", FuzzyTermType.TYPE_singletonShape,
				(new float[] { 3f }));
