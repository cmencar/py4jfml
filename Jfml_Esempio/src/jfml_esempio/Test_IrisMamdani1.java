...
public class Test_IrisMamdani1 {
	public static void main(String[] args) {
		...
		File dirXMLFiles = new File("C:/Users/andrea/workspace/Jfml_Esempio/XMLFiles/");
		if (!dirXMLFiles.exists())
			dirXMLFiles.mkdir();
		
		File irisXMLFile = new File("C:/Users/andrea/workspace/Jfml_Esempio/XMLFiles/IrisMamdani1.xml");
